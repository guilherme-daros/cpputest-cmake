...
namespace CommandLineParser
{
    ...
    const std::unordered_map<std::string, arg_handler> arguments{
        ...
        {"--output", [](my_settings &s, const std::string &arg)
         { s.outfile = arg; }},
        {"-o", [](my_settings &s, const std::string &arg)
         { s.outfile = arg; }},

        {"--value", [](my_settings &s, const std::string &val)
         { s.value = std::stoi(val); }},
    };
